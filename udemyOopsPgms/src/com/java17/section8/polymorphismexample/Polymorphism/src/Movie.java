 ...
 * 
 * return switch (type.toUpperCase().charAt(0)) { case 'A' -> new
 * Adventure(title); case 'C' -> new Comedy(title); case 'S' -> new
 * ScienceFiction(title); default -> new Movie(title); }; } }
 * 
 * 
 ...
 * @Override
 * 
 * public void watchMovie() { super.watchMovie();
